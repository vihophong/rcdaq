...
//  else if(id==1)
//    MyDataSink= SpyDataSink( "/dev/shm/SHM_110206");
//  else if(id==2)
//    MyDataSink= SpyDataSink( "/dev/shm/SHM_110207");
...
MyMainFrame::MyMainFrame(const TGWindow *p, UInt_t w, UInt_t h)
{
    ...
    double ul2d= 10e3;
   	...
   	if(Master==0){ 
    		...
    		h1X=new TH1F("Check","RIBF-BRIKEN time difference;                                x40ns",4000, ll1d, ul1d);
    		h1Y=new TH1F("Check","AIDA-BRIKEN time difference;                                x40ns",4000, ll1d, ul1d);
	}
	        else if(Master==1){
